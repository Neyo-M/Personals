...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Antonio Lestimasi Moeaki \vspace{2pt}} & % row = 1, col = 1
  Nuku'alofa, Tonga. \\ % row = 1, col = 2
  \href{https://al.moeaki@gmail.com}{\faIcon{envelope} \uline{al.moeaki@gmail.com}} $|$ % row = 2, col = 1
  \href{https://www.linkedin.com/in/antonio-moeaki-7893701a5/}{\faLinkedin \uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/Neyo-M?tab=repositories}{\faGithub  \uline{GitHub}} $|$ % row = 2, col = 1
  \href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
  Mobile: +676 8430519 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\section{Education}
  \resumeHeadingListStart{}
    \resumeQuadHeading{Bachelor of Mathematics (Statistics)}{ 2021 -- 2024}
    {Queensland University of Technology}{Brisbane, QLD}
    {GPA 6.875/7.0}

      \resumeQuadHeading{Bachelor of Business (Economics)}{ 2021 --  2024}
    {Queensland University of Technology}{Brisbane, QLD}
    {GPA 6.75/7.0}

    \textbf{Awards}
 \resumeItemListStart{}
          \resumeItem{\textbf{Deans List 2021-2024:} Achieved a GPA over 6.5 (out of 7) for eight consecutive semesters.}
          \resumeItem{\textbf{International Undergraduate Award 2022:} Highest GPA in the Business faculty in the academic year 2022.}
      \resumeItem{\textbf{Executive Director's Award for Academic Excellence 2020:} Highest GPA in the international cohort 2020.}
...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Economist}{January 2025 -- Present}
  {Ministry of Finance}{Full-time -- Nuku'alofa, Tonga}
    \resumeItemListStart{}
     \resumeItem{\textbf{Forecasted} GDP growth over Tertiary sub-sectors: Education, Public, and ICT sectors }
      \resumeItem{Submitted \textbf{a policy paper} which analysed PALM and RSE labor mobility schemes in Tonga, pinpointing adverse effects and recommending strategies to improve its value}
      \resumeItem{Utilized \textbf{Rstudio and Excel} for data wrangling and data visualizations}
     \resumeItem{Completed \textbf{Exchange Rate Policy} training in Singapore, and applied an EBA analysis and constructed an early warning system based on Tonga's foreign reserves and exchange rate movements.}
      \resumeItem{Engagement with \textbf{Government Financial Statistics} (GFS) manual and training to improve Tonga's classification and coverage systems under ICS and IMF consolidation}

    \resumeItemListEnd{}

  \resumeQuadHeading{Year 13 Statistics Tutor}{March 2025 -- July 2025}
  {Alafolau Fakaako}{Part-time -- Nuku'alofa, Tonga}
    \resumeItemListStart{}
      \resumeItem{Developed and delivered 2hr interactive Lecture and Excercise material for Year 12 \& Year 13 students using pedagogy principles}
      \resumeItem{Simulated experimental designs in \textbf{Rstudio} and provided sample assignments mirroring closely real assignemnt conditions for students. }
    \resumeItemListEnd{}
